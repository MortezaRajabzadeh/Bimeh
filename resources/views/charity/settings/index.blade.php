                            ...
                            <div class="mt-2 flex items-start space-x-4 space-x-reverse">
                                ...
                                <div class="flex-shrink-0 w-24 h-24 bg-gray-100 rounded-lg overflow-hidden">
                                    @if(auth()->user()->organization && auth()->user()->organization->logo_path)
                                        <img src="{{ auth()->user()->organization->logo_url }}" alt="لوگوی خیریه" class="w-full h-full object-contain" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                        <div class="w-full h-full hidden items-center justify-center bg-gray-200 text-gray-500">
