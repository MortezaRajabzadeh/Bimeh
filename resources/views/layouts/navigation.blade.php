...
<div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-reverse space-x-2 sm:space-x-4 overflow-x-auto hide-scrollbar">
                <!-- دکمه دانلود اکسل -->
                <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-green-600 bg-white border border-green-600 rounded-md hover:bg-green-50 transition">
                ...
                @if(auth()->check())
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-red-600 bg-white border border-red-600 rounded-md hover:bg-red-50 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span class="sm:hidden">مدیر</span>
                    </a>
                    @endif
                @endif
            </div>
