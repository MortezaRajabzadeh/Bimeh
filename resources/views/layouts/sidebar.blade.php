...
<div class="sidebar-menu" id="sidebar-menu">
    <div class="fixed h-screen right-0 top-0 w-64 bg-white shadow-md py-5 z-40 transition-all duration-300">
        ...
        <button id="sidebar-toggle-btn" class="absolute top-[380px] left-0 transform -translate-x-full p-3 bg-green-500 text-white hover:bg-green-600 rounded-r-lg shadow-md focus:outline-none transition-all duration-300">
