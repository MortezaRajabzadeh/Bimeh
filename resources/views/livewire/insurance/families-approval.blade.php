...
<div class="flex flex-col items-center relative z-10">
    ...
    <div x-show="$wire.showExcelUploadModal"
         ...
         x-data="{
            ...
            validateFile(event) {
                ...
                if (!this.allowedExtensions.includes(ext)) {
                    ...
                    this.validationError = 'فرمت فایل باید .xlsx یا .xls باشد';
                    return;
                }
                
                if (file.size > this.maxFileSize) {
                    this.isValidFile = false;
                    this.validationError = 'حجم فایل نباید بیشتر از 10 مگابایت باشد';
                    return;
                }
        ...
        class="w-full max-w-4xl bg-white rounded-xl shadow-2xl overflow-hidden">
            ...
            <!-- Header -->
            <div class="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-blue-50">
                <h3 class="text-2xl font-bold text-gray-800 flex items-center">
                    <svg class="w-7 h-7 ml-2 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    آپلود فایل اطلاعات صدور
                </h3>
                <button wire:click="closeExcelUploadModal" class="text-gray-400 hover:text-gray-600 transition-colors">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
                </button>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-5 border border-green-200">
                    <div class="flex items-center">
                        <svg class="w-10 h-10 text-green-600 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                        <div>
                            <p class="text-lg font-bold text-green-800">
                                <span x-text="$wire.selected.length"></span> خانواده انتخاب شده
                            </p>
                            <p class="text-sm text-green-700">معادل {{ $totalMembers }} نفر آماده بیمه</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 rounded-xl p-5 border border-blue-200">
                    <div class="flex items-start">
                        <svg class="w-6 h-6 text-blue-600 ml-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <div class="flex-1">
                            <h4 class="text-base font-bold text-blue-900 mb-3">مراحل تکمیل فرآیند بیمه:</h4>
                            <ol class="text-sm text-blue-800 space-y-2">
                                <li class="flex items-start">
                                    <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-200 text-blue-900 font-bold ml-2 flex-shrink-0">1</span>
                                    <span class="flex-1">با کلیک روی دکمه زیر، فایل نمونه اکسل را دانلود کنید</span>
                                </li>
                                <li class="flex items-start">
                                    <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-200 text-blue-900 font-bold ml-2 flex-shrink-0">2</span>
                                    <span class="flex-1">فایل را با اطلاعات بیمه (شماره بیمه‌نامه، تاریخ‌ها و ...) تکمیل کنید</span>
                                </li>
                                <li class="flex items-start">
                                    <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-200 text-blue-900 font-bold ml-2 flex-shrink-0">3</span>
                                    <span class="flex-1">فایل تکمیل شده را در بخش زیر آپلود نمایید</span>
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="flex justify-center">
                    <button type="button" 
                            ...
                            wire:loading.attr="disabled"
                            wire:target="downloadSampleTemplate"
                            class="inline-flex items-center px-6 py-3 bg-blue-600 border border-transparent rounded-xl text-base font-bold text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed">
                        <span wire:loading.remove wire:target="downloadSampleTemplate" class="flex items-center">
                            <svg class="w-6 h-6 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5m0 0l5-5m-5 5V4" />
                            </svg>
                            دانلود فایل نمونه اکسل
                        </span>
                        <span wire:loading wire:target="downloadSampleTemplate" class="flex items-center">
                ...
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-4 bg-white text-gray-500 font-medium">پس از تکمیل فایل</span>
                    </div>
                </div>

                <!-- فرم آپلود -->
                <form wire:submit.prevent="uploadInsuranceExcel" class="space-y-4">
                    <!-- راهنمای الزامات فایل -->
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div class="flex items-start">
                            <svg class="w-5 h-5 text-gray-600 ml-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <div class="flex-1">
                                <h5 class="text-sm font-bold text-gray-800 mb-1">الزامات فایل:</h5>
                                <ul class="text-xs text-gray-600 space-y-1">
                                    <li class="flex items-center">
                                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 ml-2"></span>
                    ...
                    <div>
                        ...
                        <label for="excel-upload-input" class="cursor-pointer block">
                            <div class="border-2 border-dashed border-green-300 rounded-xl p-6 text-center hover:border-green-400 hover:bg-green-50 transition-all duration-200">
                                <svg class="mx-auto w-12 h-12 text-green-600 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                                </svg>
                                <p class="text-base font-bold text-green-700 mb-1">آپلود فایل اکسل تکمیل شده</p>
                                <p class="text-sm text-gray-500">فایل خود را اینجا بکشید یا کلیک کنید</p>
                            </div>
                        </label>
                    </div>

                    <!-- Progress bar هنگام آپلود -->
                    <div wire:loading wire:target="uploadInsuranceExcel" class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                        <div class="flex items-center">
                            <svg class="animate-spin w-6 h-6 text-blue-600 ml-3" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <div class="flex-1">
                                <p class="text-sm font-bold text-blue-800">در حال آپلود فایل...</p>
                    ...
                    <div x-show="fileSelected" x-transition class="space-y-3">
                        <div :class="isValidFile ? 'border-green-300 bg-green-50' : 'border-red-300 bg-red-50'" class="border-2 rounded-lg p-4">
                            <div class="flex items-center">
                                <div :class="isValidFile ? 'bg-green-100' : 'bg-red-100'" class="rounded-lg p-3 ml-3">
                                    <svg :class="isValidFile ? 'text-green-600' : 'text-red-600'" class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p :class="isValidFile ? 'text-green-900' : 'text-red-900'" class="text-sm font-bold truncate" x-text="fileName"></p>
                                    <p :class="isValidFile ? 'text-green-700' : 'text-red-700'" class="text-xs" x-text="fileSizeFormatted"></p>
                                </div>
                                <div class="mr-3">
                                    <svg x-show="isValidFile" class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <svg x-show="!isValidFile" class="w-8 h-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div x-show="validationError" x-transition class="bg-red-100 border border-red-300 rounded-lg p-3">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm font-medium text-red-800" x-text="validationError"></p>
                            </div>
                        </div>

                        <!-- پیام موفقیت اعتبارسنجی -->
                        <div x-show="isValidFile" x-transition class="bg-green-100 border border-green-300 rounded-lg p-3">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 text-green-600 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <p class="text-sm font-medium text-green-800">فایل معتبر است و آماده آپلود می‌باشد</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- دکمه ارسال -->
                    <div x-show="$wire.insuranceExcelFile" x-transition class="pt-2">
                        <button type="submit"
                                x-bind:disabled="!isValidFile"
                                class="w-full py-3 px-4 bg-green-700 text-white font-bold rounded-xl hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                                wire:loading.attr="disabled"
                                wire:target="uploadInsuranceExcel">
                            <span wire:loading.remove wire:target="uploadInsuranceExcel" class="flex items-center justify-center">
                                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                </svg>
                                تایید و ارسال فایل
                            </span>
                            <span wire:loading wire:target="uploadInsuranceExcel" class="flex items-center justify-center">
                    ...
                    <div class="flex justify-end pt-2">
                        <button type="button"
                                ...
                                class="px-6 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors">
                            انصراف
                        </button>
                    </div>
                </form>
